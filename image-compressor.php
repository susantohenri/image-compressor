...
function image_compressor_shortcode_callback($atts, $content=""){
	...
	<div class="custom_wrapper_two">
		<div class="buttonWrapper">
			...
			<i class="fa-regular fa-circle-up"></i>&nbsp;Upload</div>
		...
		<div class="buttonWrapper">
			...
			<i class="fa-regular fa-circle-down"></i>&nbsp;Download All</div>
		</div>
	</div>
    <!-- Main div container -->
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function($){
			...
			$('.scroll-button').on('click', function(){
				...
				container.stop().animate({scrollLeft: dir+container[0].offsetWidth}, 500/*, ()=> container.css('scroll-snap-type', 'none')*/);
			});
